    ...
    <div className="min-h-screen px-4 py-8">
      <div className="mx-auto max-w-xl">
        ...
        <div className="rounded-2xl bg-white/70 px-6 py-6 shadow-sm backdrop-blur">
          ...
          <p className="mt-2 text-sm leading-relaxed text-stone-600">{t("この規約は、日程組（以下「本サービス」）の利用条件を定めるものです。 利用者は、本サービスを利用することで本規約に同意したものとみなします。")}</p>

          <h2 className="mt-6 font-serif text-base text-rose-800">{t("第1条（サービス内容）")}</h2>
          ...
          <h2 className="mt-6 font-serif text-base text-rose-800">{t("第2条（ログインがないことによる特性）")}</h2>
          ...
          <h2 className="mt-6 font-serif text-base text-rose-800">{t("第3条（投稿内容の責任）")}</h2>
          ...
          <h2 className="mt-6 font-serif text-base text-rose-800">{t("第4条（禁止事項）")}</h2>
          ...
          <h2 className="mt-6 font-serif text-base text-rose-800">{t("第5条（イベント・回答の削除）")}</h2>
          <ul className="mt-1 list-disc space-y-1 pl-5 text-sm leading-relaxed text-stone-600">
          ...
          <h2 className="mt-6 font-serif text-base text-rose-800">{t("第6条（カレンダーファイルと端末内の保存）")}</h2>
          <ul className="mt-1 list-disc space-y-1 pl-5 text-sm leading-relaxed text-stone-600">
          ...
          <h2 className="mt-6 font-serif text-base text-rose-800">{t("第7条（支援について）")}</h2>
          ...
          <h2 className="mt-6 font-serif text-base text-rose-800">{t("第8条（外部サービス）")}</h2>
          ...
          <h2 className="mt-6 font-serif text-base text-rose-800">{t("第9条（免責事項）")}</h2>
          <ul className="mt-1 list-disc space-y-1 pl-5 text-sm leading-relaxed text-stone-600">
          ...
          <h2 className="mt-6 font-serif text-base text-rose-800">{t("第10条（サービスの変更・停止・終了）")}</h2>
          <p className="mt-1 text-sm leading-relaxed text-stone-600">{t("運営者は、事前の告知なく、本サービスの全部または一部を変更・停止・終了できるものとします。")}</p>

          <h2 className="mt-6 font-serif text-base text-rose-800">{t("第11条（規約の変更）")}</h2>
          ...
          <h2 className="mt-6 font-serif text-base text-rose-800">{t("第12条（個人情報の取り扱い）")}</h2>
          ...
          <h2 className="mt-6 font-serif text-base text-rose-800">{t("第13条（準拠法）")}</h2>
          <p className="mt-1 text-sm leading-relaxed text-stone-600">{t("本規約は日本法に準拠します。")}</p>

          <h2 className="mt-6 font-serif text-base text-rose-800">{t("第14条（お問い合わせ）")}</h2>
